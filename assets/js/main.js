(function ($) {
   ...
   *   Company Logo
   *****************************************/
  var company_logo_slider = new Swiper(
   ...
   *   Testimonial
   *****************************************/
  var testimonial_thumb = new Swiper(
    ".testimonial-thumb-slider .swiper-container",
    {
      slidesPerView: 3,
      speed: 2500,
      loop: true,
  ...
  var testimonial_content = new Swiper(
    ".testimonial-content-slider .swiper-container",
    {
      loop: true,
      speed: 2500,
      autoplay: true,
   ...
   *   Blog Feed - Style 1
   *****************************************/
  var blog_feed_slider_1 = new Swiper(
    ".blog-feed-slider-style-1 .swiper-container",
    {
      slidesPerView: 2,
      spaceBetween: 60,
      speed: 2500,
   ...
   *   Blog Feed - Style 2
   *****************************************/
  var blog_feed_slider_2 = new Swiper(
    ".blog-feed-slider-style-2 .swiper-container",
    {
      slidesPerView: 2,
      spaceBetween: 40,
      speed: 2500,
  ...
  var projects_large_image = new Swiper(
    ".project-large-slider .swiper-container",
    {
      speed: 1500,
      spaceBetween: 30,
      slidesPerView: 1,
